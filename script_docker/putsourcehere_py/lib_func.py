...
#→  2. TheAlgorithms Python - https://github.com/subbarayudu-j/TheA...
#→  3. Python Programming Exercises - https://github.com/zhiwehu/Python-pro...
#→  4. Python Master Class - https://github.com/kanacb/pythonmaste...
#→  5. Python-DS - https://github.com/prabhupant/python-ds
